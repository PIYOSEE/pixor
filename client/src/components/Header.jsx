  ...
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
        ...
        className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'>
          Turn text to <span className='text-purple-900'>image</span>, in seconds</h1>

        <p className='text-center max-w-xl mx-auto mt-6'>Unleash your creativity with AI. Turn your imagination into visual art in seconds – just type, and watch the magic happen.</p>
