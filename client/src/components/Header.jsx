...
const Header = () => {
  return (
    ...
    >
        ...
        >
          Turn text to <span className='text-purple-900'>image</span>, in seconds</motion.h1>
        ...
        <motion.button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full cursor-pointer'
        ...
        className='mt-2 text-neutral-600'>Generated images from Pixor</motion.p>
